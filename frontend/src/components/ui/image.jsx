 ...
 * server-side, optionally anchored at a focal point. Other URLs (including
 * images served by your own backend) render as a plain <img>. Failed loads
 * swap to a fallback image.
 */
